...
export function PileGroupPanel({ onAddElement, onDeleteElement }: PileGroupPanelProps) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h3 className="text-sm font-medium text-slate-200 mb-2">Pile Group</h3>

        {pileGroups.length === 0 ? (
          <p className="text-xs text-slate-500">কোনো Pile Group যোগ করা হয়নি।</p>
        ) : (
      ...
      {noMaterials ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-2.5 border-t border-slate-800 pt-3">
          ...
          <div>
            <p className="text-xs text-slate-500 mb-1">Centroid Location (m)</p>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="block text-xs text-slate-500 mb-1">Pile Shape</label>
              <select
                value={pileShape}
            ...
            <div>
              <label className="block text-xs text-slate-500 mb-1">Diameter/Width (mm)</label>
              <input
                type="number"
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="block text-xs text-slate-500 mb-1">Embedded Length (mm)</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-xs text-slate-500 mb-1">Spacing c/c (mm)</label>
              <input
                type="number"
                value={spacingMm}
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="block text-xs text-slate-500 mb-1">Rows (Z-দিকে)</label>
              <input
                type="number"
                value={rows}
            ...
            <div>
              <label className="block text-xs text-slate-500 mb-1">Columns (X-দিকে)</label>
              <input
                type="number"
                value={columns}
