...
const COLOR_STAIR_LANDING = "#c084fc"; // COLOR_STAIR এর হালকা variant — একই stair system-এর অংশ (flat platform, ঢালু waist slab-এর বিপরীতে), তাই কাছাকাছি hue কিন্তু distinguishable
...
function getAreaElementColor(category: "slab" | "wall" | "shear-wall" | "core-wall" | "stair" | "stair-landing" | "parapet"): string {
  switch (category) {
    case "slab":
      return COLOR_SLAB;
    case "wall":
