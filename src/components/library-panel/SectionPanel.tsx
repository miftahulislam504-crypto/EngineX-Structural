...
import { PRESET_GROUPS, ALL_STANDARD_PRESETS } from "@/lib/library/standardSectionPresets";
...
// Standard size preset তালিকা (Beam/Column/Footing/Slab) এখন
// @/lib/library/standardSectionPresets এ shared module হিসেবে আছে —
// autoAssignSection.ts (element তৈরির সময় auto section select) একই
// তালিকা reuse করে, তাই দুই জায়গায় duplicate রাখা হয়নি।
